...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT id, account_number, account_type, balance, APY, active FROM Accounts WHERE user_id=:id order by created Desc LIMIT 5");
    ...
    <?php if (count($results) > 0): ?>
        <div class="list-group-item">
		   ...
		   <div class="list-group-item">
            ...
            <!-- <button class = "btn btn-primary" onclick="deleteAcc()"></button> -->
